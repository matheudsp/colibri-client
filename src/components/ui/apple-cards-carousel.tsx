  ...
  return (
    ...
    >
      <div className="relative max-w-7xl mx-auto space-y-4 ">
        <div
          className="flex w-full overflow-x-hidden overflow-y-hidden overscroll-x-auto scroll-smooth  [scrollbar-width:none]  "
          ref={carouselRef}
        ...
        <div className="mr-10 flex justify-end gap-2">
          <button
            className="relative z-40 flex h-10 w-10 items-center justify-center rounded-full bg-card disabled:opacity-50"
            onClick={scrollLeft}
      ...
      <AnimatePresence>
        {open && (
          <div className="fixed inset-0 z-50 h-screen overflow-auto">
            ...
            >
              <button
                className="cursor-pointer sticky top-4 right-0 ml-auto flex h-8 w-8 items-center justify-center rounded-full bg-destructive/40"
                onClick={handleClose}
              >
                <IconX className="h-6 w-6 text-destructive-foreground" />
              </button>
              <motion.p
